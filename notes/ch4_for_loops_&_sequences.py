...
# ITERATE = to step through a sequence, in order, one element at a time

# FOR LOOP = iterates through a sequence and executes the body of the
...
# A more concise alternative using "if" and "in" to check to see if an element
#	is in a sequence
print("\nAlternative:")
if "a" in name.lower():
     print ("Awesome, you have an A!")
